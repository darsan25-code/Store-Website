...
const productsData: Product[] = [
  {
    id: 'tiles-1',
    name: 'KAG Vitrified Tiles (600x600mm)',
    price: 85,
    image: 'https://images.unsplash.com/photo-1695191388218-f6259600223f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjZXJhbWljJTIwZmxvb3IlMjB0aWxlc3xlbnwxfHx8fDE3Njc4MDY4ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Premium vitrified floor tiles with glossy finish - per piece'
  },
  {
    id: 'tiles-2',
    ...
    price: 65,
    image: 'https://images.unsplash.com/photo-1695191388218-f6259600223f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjZXJhbWljJTIwZmxvb3IlMjB0aWxlc3xlbnwxfHx8fDE3Njc4MDY4ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Modern ceramic wall tiles with elegant patterns - per piece'
  },
  {
    id: 'tiles-3',
    name: 'Polished Porcelain Tiles (800x800mm)',
    price: 125,
    image: 'https://images.unsplash.com/photo-1695191388218-f6259600223f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjZXJhbWljJTIwZmxvb3IlMjB0aWxlc3xlbnwxfHx8fDE3Njc4MDY4ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Large format porcelain tiles with high shine - per piece'
  },
  {
    id: 'tiles-4',
    name: 'Outdoor Parking Tiles (300x300mm)',
    price: 45,
    image: 'https://images.unsplash.com/photo-1695191388218-f6259600223f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjZXJhbWljJTIwZmxvb3IlMjB0aWxlc3xlbnwxfHx8fDE3Njc4MDY4ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Anti-skid outdoor tiles for parking and pathways - per piece'
  },
  {
    id: 'tiles-5',
    name: 'Marble Finish Tiles (600x1200mm)',
    price: 180,
    image: 'https://images.unsplash.com/photo-1695191388218-f6259600223f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjZXJhbWljJTIwZmxvb3IlMjB0aWxlc3xlbnwxfHx8fDE3Njc4MDY4ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Premium marble-look tiles with realistic veining - per piece'
  },
  {
    id: 'tiles-6',
    name: 'Bathroom Floor Tiles (300x600mm)',
    price: 55,
    image: 'https://images.unsplash.com/photo-1695191388218-f6259600223f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjZXJhbWljJTIwZmxvb3IlMjB0aWxlc3xlbnwxfHx8fDE3Njc4MDY4ODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Slip-resistant bathroom tiles with modern design - per piece'
  }
];
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <div className="inline-flex items-baseline gap-2 px-4 py-2 bg-gradient-to-r from-[#B11226]/20 to-[#D61C3A]/20 border border-[#B11226]/30 rounded-xl">
            ...
            <span className="text-gray-300 text-sm">per piece</span>
          </div>
        </div>
...
export function TilesPage({ onBackToHome, onNavigateToCart }: { onBackToHome: () => void; onNavigateToCart: () => void }) {
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-[#B11226] via-[#D61C3A] to-[#B11226] bg-clip-text text-transparent">Tiles (Floor & Wall)</span>
            </motion.h1>
            ...
            >
              Extensive collection of ceramic, vitrified, and designer tiles for all your flooring and wall needs
            </motion.p>
          </motion.div>
